document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            'contact-location': '📍 Ubicación: Av. Principal 123, Ciudad, País (Actualiza con tu dirección real)',
            ...
            'tantric-b-desc': 'Un paso más profundo hacia la intimidad energética.<br>La experiencia incluye meditación activa, ejercicios de conexión visual, respiración compartida y estimulación sensorial más intensa, cuerpo a cuerpo (nuru) completo (con pechos, brazos, piernas, glúteos).<br>El cuerpo fluye entre estar acostado y posturas suaves que favorecen la apertura energética.<br>La masajista puede ser tocada con respeto (brazos, espalda, piernas).<br>Incluye masaje lingam, enfocado en conducir la energía con consciencia.<br>Más tacto, más presencia, más conexión.',
        ...
        en: {
            ...
            'contact-location': '📍 Location: Av. Principal 123, City, Country (Update with your real address)',
